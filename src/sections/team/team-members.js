...
const TeamMembers = () => {
	...
	useEffect(() => {
		console.log(queryString.parse(window.location.search).role)
		console.log(queryString.parse(window.location.search).lab)
		console.log(queryString.parse(window.location.search).project)
								...
								<div className="grid__item">
									<TeamMemberCard
										profilePicture={
											...
											member.profilePicture.fluid.srcWebp
										}
