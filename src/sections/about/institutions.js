...
const Institutions = () => {
  const data = useStaticQuery(graphql`
    query {
      mountSinai: file(relativePath: { eq: "about/institution-mount-sinai.png" }) {
        childImageSharp {
      ...
      logoIcahnSchool: file(relativePath: { eq: "about/logo-icahn-school.png" }) {
        childImageSharp {
    ...
    <StyledInstitutions>
      <Container>
        ...
        <Grid gutter="32" columns="2">
          <div className="grid__item">
            <div className="institution__card">
              <Img fluid={data.mountSinai.childImageSharp.fluid} className="institute__image" alt="Mount Sinai Health System" />
          ...
          <div className="grid__item">
            <div className="institution__card">
              <Img fluid={data.hassoPlattner.childImageSharp.fluid} className="institute__image" alt="Mount Sinai Health System" />
        ...
        <div className="disclaimer bg--blue500">
          <p className="color--white font-weight--600">The Hasso Plattner Institute for Digital Health at Mount Sinai is generously supported through a philanthropic gift by the Hasso Plattner Foundation.</p>
        </div>
      </Container>
    </StyledInstitutions>
  )
