  ...
  return (
    <StyledPublicationCard active={active}>
      <div className="publication__info">
        <p className="publication__date paragraph--small color--grey900">
          {props.year}
        </p>
        <p className="publication__title font-weight--600">
          <a
            href={props.link}
            className="color--blue900 color-hover--blue300"
            target="_blank"
        ...
        <p className="info info--journal paragraph--small color--grey900">
          ...
          <span className="journal-title font-weight--500">
            {" "}
            {props.journal}
          </span>
        </p>
      ...
      <div className="publication__actions">
        ...
        <ExternalLink
          href={props.link}
          className="link color--blue500 color-hover--blue300 border--blue500 svg--stroke-blue500 svg-hover--stroke-blue300"
